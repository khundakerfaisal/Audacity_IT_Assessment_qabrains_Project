...
public class ProductListingPage {
    ...
    @FindBy(xpath = "//a[text()='Sample Shirt Name']")
...
//    @FindBy(xpath = "(//button[@type='button'][normalize-space()='Add to cart'])[1]")
    ...
    public void productCartPage() throws InterruptedException {
        Thread.sleep(2000);
        ProductLists.click();
        Thread.sleep(2000);
    ...
    public boolean isProductsDisplayed() {
        try {
            wait.until(ExpectedConditions.visibilityOf(ProductLists));
            return ProductLists.isDisplayed();
        } catch (Exception e) {
            return false;
        }
    }
