...
//        Thread.sleep(1000);
    ...
    public void testAddItemsToCart() throws InterruptedException {
        ...
        productListingPage.productCartPage();
...
//    @Test(priority = 3, description = "Test adding items to favorites and verify presence",enabled = false)
...
//    }
//
//    @Test(priority = 4, description = "Test sorting functionality for product listings",enabled = false)
...
//    }
//
//    @Test(priority = 5, description = "Test complete checkout flow",enabled = false)
...
//    }
//
//    @Test(priority = 6, description = "Test checkout success and error messages",enabled = false)
...
//    }
//
//    @Test(priority = 7, description = "Test empty cart checkout edge case",enabled = false)
...
//    }
//
//    @Test(priority = 8, description = "Test invalid payment details edge case",enabled = false)
...
//    }
//
//    @Test(priority = 10, description = "Test cart quantity update",enabled = false)
...
//    }
//
//    @Test(priority = 11, description = "Test remove item from cart",enabled = false)
